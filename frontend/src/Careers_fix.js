  ...
  const CareerExplorer = ({ isLoading, careerDatabase }) => (
    <div className="p-6">
        ...
        <div key={category} className="mb-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {careers.map((career, index) => (
              <div key={index} className="bg-white p-6 rounded-xl shadow-lg border hover:shadow-xl transition-shadow relative overflow-hidden group">
